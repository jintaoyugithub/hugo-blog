...
<!-- Note: need to fill featuredImage in the content markdown file to make the whole website to be compiled by hugo, and you have to upload the image to the actual server, otherwise hugo won't compile the website -->
